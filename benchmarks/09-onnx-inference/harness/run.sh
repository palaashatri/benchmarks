...
MAIN_CLASS="com.palaashatri.bench.b09.harness.BenchmarkHarness"
JAVA_RELEASE="17"
ROLE="harness"
DEFAULT_PORT="18009"
SMOKE_GETS='/api/v1/inference/health'
SMOKE_POSTS='/api/v1/inference/classify::{"text":"local inference is deterministic"}'
