...
MAIN_CLASS="com.palaashatri.bench.b07.harness.BenchmarkHarness"
JAVA_RELEASE="21"
ROLE="harness"
DEFAULT_PORT="18007"
SMOKE_GETS='/functions'
SMOKE_POSTS='/invoke/json-transform::{"payload":"abc"}|/invoke/lightweight-infer::{"payload":"abc"}'
