...
MAIN_CLASS="com.palaashatri.bench.b02.harness.BenchmarkHarness"
JAVA_RELEASE="21"
ROLE="harness"
DEFAULT_PORT="18002"
SMOKE_GETS='/flows/evt-smoke'
SMOKE_POSTS='/events::{"id":"evt-smoke","type":"checkout"}|/notifications/stub::{"id":"evt-smoke"}'
