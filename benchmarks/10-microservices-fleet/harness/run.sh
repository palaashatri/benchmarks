...
MAIN_CLASS="com.palaashatri.bench.b10.harness.BenchmarkHarness"
JAVA_RELEASE="17"
ROLE="harness"
DEFAULT_PORT="18010"
SMOKE_GETS='/api/v1/catalog/1001|/api/v1/orders/order-1'
SMOKE_POSTS='/api/v1/orders::{"productId":"1001","quantity":1}'
